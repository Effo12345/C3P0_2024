...
void checkpoint4() {
    ...
    chassis->turn(-45.0f, 2.0f);
    chassis->turn(-90.0f, 2.0f);
    
    gui->pause();

    chassis->followNewPath({
        {10.9921261682243, 9.438300765113297},
        {9.286366440691335, 9.66986007300054},
        {7.600739147170834, 9.816273087645282},
        {5.944060996908638, 9.78529850993067},
        {4.34572429906542, 9.690661746421707}
    },{46.20470244297694,
        39.79980973175084,
        32.28921124290297,
        22.63544792202516,
